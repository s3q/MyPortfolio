...
const contactIntro =
  "Open to internships, projects, and collaboration in embedded systems, networking, and software.";
const quickActions = [
  {
    label: "Email",
    className: "but whatsapp",
...
${formData.message}
  ...
  <form class="form-body">
    ...
    <div class="form-group">
      ...
      <textarea
        rows="5"
        placeholder="Share project details, goals, or how I can help."
        required
      ></textarea>
    </div>
...
<div className="sidebar">
  ...
  <div className="spcard cocard">
    ...
    <div className="location">
      ...
      <p>
        Muscat, Oman <br />
        Open to internships and project collaboration <br />
      ...
      <button className="but-map">View on Map</button>
        ...
        >
          <div style={{ maxWidth: "600px", margin: "0 auto" }}>
            ...
            >
              I respond to messages within 24 hours, often sooner. For urgent
              matters, please email or reach out on LinkedIn.
            </p>
            <div
              style={{
                display: "flex",
